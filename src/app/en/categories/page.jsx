    ...
    <main className="min-h-screen bg-[#f7f3e8]">
      ...
      <section className="mx-auto max-w-6xl px-3 py-10 md:px-4">
        ...
        <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="/en"
            className="inline-flex w-fit items-center rounded-lg bg-[#3b2f2f] px-5 py-2.5 text-sm font-semibold text-yellow-200 transition hover:bg-[#4a3a3a]"
          >
            ← Home
          </Link>
        ...
        {loading && (
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:gap-4 lg:grid-cols-4">
            ...
            {Array.from({ length: 12 }).map((_, index) => (
              <div
                key={index}
                className="min-h-[100px] animate-pulse rounded-2xl border border-gray-200 bg-white"
              />
            ))}
        ...
        {!loading && englishCategories.length === 0 && (
          ...
          <div className="rounded-2xl border border-yellow-200 bg-white px-6 py-14 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-500">
              English categories have not been added yet.
            </p>
